...
<body>
    ...
    <button type="submit" class="btn btn-outline-primary float-right mt-3 mb-5" data-toggle="modal" data-target=".bd-example-modal-md" onclick="location.href='userprofile.php'">Update</button>
    <button type="button" class="btn btn-outline-primary float-center mt-3 mb-5" data-toggle="modal" data-target=".bd-example-modal-md" onclick="location.href='profile.php'">Back</button>
